...
function elementRandomizer({ elements }) {
    ...
    if (getEnabled("randomIcons")) {
        elements.forEach(element => {
            ...
            const hasIcons = elementChildren.some(el => el.tagName === "I" && el.classList.contains("material-icons"));
    ...
    if (getEnabled("randomTooltip")) {
        elements.forEach(element => element.title = getRandomText());
    }
